    ...
    def process_queue(self):
        while self.queue:
            ...
            try:
                ...
                # App.Matrix4d does not exist → use App.Matrix
                code = code.replace("App.Matrix4d()", "App.Matrix()")
                code = code.replace("App.Matrix4d", "App.Matrix")
                # Fix scale pattern: scale_matrix = App.Matrix(); scale_matrix.scale(...)
                # then scale_matrix.multiply(matrix) → matrix.multiply(scale_matrix)
                # This is a no-op replacement for the pattern if it happens
