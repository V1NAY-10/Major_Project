...
EXPLAIN_SYSTEM_PROMPT = (
    ...
    "- Exact XYZ coordinates based on their 'center' [X, Y, Z] list\n"
...
MODIFY_SYSTEM_PROMPT = (
    ...
    "You will be given:\n"
    "1. Structured CAD data — every component has:\n"
    "   - 'center': [X, Y, Z] coordinate list in mm from origin\n"
    "   - 'axis': [X, Y, Z] orientation vector\n"
    "   - Key dimensions like 'radius', 'diameter', 'height', 'length', 'width'\n"
    "   - 'semantic_label': list of descriptive names e.g. ['top', 'left']\n"
